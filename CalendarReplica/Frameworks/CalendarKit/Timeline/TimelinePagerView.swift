...
public protocol TimelinePagerViewDelegate: AnyObject {
  ...
  func timelinePagerDidLongPressTimelineAtHour(_ hour: Int)
    func timelinePagerDidReleaseLongPressTimelineAtHour(_ hour: Int)
    func timelinePagerDidMoveLongPressTimelineAtHour(_ hour: Int)
...
extension TimelinePagerView: TimelineViewDelegate {
  public func timelineView(_ timelineView: TimelineView, didLongPressAt hour: Int) {
    ...
    public func timelineView(_ timelineView: TimelineView, didReleaseLongPressAt hour: Int) {
        delegate?.timelinePagerDidReleaseLongPressTimelineAtHour(hour)
    }
    
    public func timelineView(_ timelineView: TimelineView, didMoveLongPressAt hour: Int) {
        delegate?.timelinePagerDidMoveLongPressTimelineAtHour(hour)
    }
}
